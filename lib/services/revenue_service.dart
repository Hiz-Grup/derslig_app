  ...
  Future<Offerings> getProducts() async {
    try {
      ...
      if (offerings.current != null) {
        ...
        for (Package element in offerings.current!.availablePackages) {
          StoreProduct storeProduct = element.storeProduct;

          print("- ${storeProduct.title} : ${storeProduct.priceString} : ${storeProduct.description} : ${storeProduct.identifier}");
        }
      }
      return offerings;
  ...
  Future<GeneralResponseModel> buyProduct(Package package) async {
    try {
      ...
      if (isPro) {
        ...
        print("Purchase successful, isPro: $isPro");
  ...
  Future<bool?> checkSubscriptionStatus() async {
    try {
      ...
      if (customerInfo.entitlements.all["pupa-premium"]!.isActive) {
        ...
        print("PRODUCT ID : ${customerInfo.entitlements.all["pupa-premium"]}");
        return true;
      } else {
        return false;
      }
      ...
      print("Error fetching pro plan info: $e");
      return null;
    }
  }
